  ...
  return (
    <div>
      <div className="flex items-center justify-center h-[90vh] w-full px-5 sm:px-0">
        <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm md:max-w-4xl w-full">
          <div className="hidden md:block w-1/2 lg:w-1/2 bg-cover bg-center mt-auto mb-auto">
            <img src={login} alt="" />
          </div>
          <form
            action=""
